...
open class SetSlice<K> @JvmOverloads constructor(val default: Boolean, rewritePolicy: RewritePolicy, isCollective: Boolean = false, debugName: String = "") :
        BasicWritableSlice<K, Boolean>(rewritePolicy, isCollective, debugName) {
